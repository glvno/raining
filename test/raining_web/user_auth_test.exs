defmodule RainingWeb.UserAuthTest do
  use RainingWeb.ConnCase, async: true

  alias Raining.Accounts
  alias Raining.Accounts.Scope
  alias RainingWeb.UserAuth

  import Raining.AccountsFixtures

  @remember_me_cookie "_raining_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RainingWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
